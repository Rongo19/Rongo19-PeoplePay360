...
// Existing browser/download PDF endpoint
const generatePayslipPDF = async (payslip, res) => {
  const employee = payslip.employeeSnapshot;

  const buffer = await generatePayslipPDFBuffer(payslip);
